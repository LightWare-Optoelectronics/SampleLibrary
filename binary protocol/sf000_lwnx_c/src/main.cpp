...
int main(int args, char **argv)
{
	...
	// NOTE: Find descriptions of each command here http://support.lightware.co.za/sf000/#/commands
	...
	// Set the output rate to 97 readings per second. (Command 66: Update rate)
	if (!lwnxCmdWriteUInt8(serial, 66, 5)) { exitCommandFailure(); }

	// Set distance output to include all information: (Command 27: Distance output)
	if (!lwnxCmdWriteUInt32(serial, 27, 0xFFFFFFFF)) { exitCommandFailure(); }
